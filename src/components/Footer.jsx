            ...
            <div className="col-xs-12 col-md-12 col-lg-4- col-xl-4">
                ...
                <div className="contenedorFooter">
                    <div className="widget subscribe no-box">
                        <img src={sismedlogo} width="100%" className="logoFooter"/>
                    </div>
                    <div className="contenedorQuienesSomos">
                        <p className="quienesSomos">¿Quienes somos?</p>
                        <p className="parrafoQuienesSomos">SISMED es una destacada empresa dedicada a la entrega de
                            domicilio de medicamentos en Colombia. Con años de experiencia en el sector farmacéutico,
                            SISMED se ha convertido en un referente en el mercado, brindando un servicio confiable y
                    ...
                    <aside>
                        <div className="contenedorContactos">
                            <div className="contactenos">
                                <h6 className="widget-title">Contactanos<span></span></h6>
                                <ul className="menu-footer"/>
                                    ...
                                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" className="bi bi-phone-fill" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        </svg> contacto@sismed.com</li>
                            </div>
                            <div className="linea-vertical"></div>
                            <div className="redesSociales">
                                <h6 className="widget-title">¡Siguenos en! <span></span></h6>
                                <ul className="menu-footer"/>
                                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <p className="FinalFooter">SISMED v1.0.0 © 2023. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
